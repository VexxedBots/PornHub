...
@borg.on(admin_cmd(pattern="gdrdfsdfsfive ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(admin_cmd(pattern="dfdffolder https?://drive\.google\.com/drive/u/\d/folders/([-\w]{25,})", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(admin_cmd(pattern="gcdfsdflear", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(admin_cmd(pattern="ghdir ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(admin_cmd(pattern="ddfrive (delete|get) ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(admin_cmd(pattern="jfjf ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
async def upload_file(http, file_path, file_name, mime_type, event, parent_id):
    ...
    body = {
        "title": file_name,
        "description": "Uploaded using the internet",
        "mimeType": mime_type,
    }
