...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        ms = (end - start).seconds
        OUTPUT_STR = """{img_size}
**Possible Related Search**: [Hunting furries should be made legal](https://www.google.com/search?client=firefox-b-d&q=Hunting+furries+should+be+made+legal)

More Info: Open this [link](https://bit.ly/3aUo5kq) in {ms} seconds""".format(**locals())
    await event.edit(OUTPUT_STR, parse_mode="HTML", link_preview=False)
