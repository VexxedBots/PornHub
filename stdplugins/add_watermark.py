...
async def _(event):
    ...
    if not os.path.isdir("./iclapcheeks/watermark/"):
        os.makedirs("./iclapcheeks/watermark/")
    if event.reply_to_msg_id:
        ...
        try:
            ...
            watermark(
                ...
                outputpdf='./iclapcheeks/watermark/' + reply_message.file.name,
                watermarkpdf='./bin/watermark.pdf'
            )
        # filename = sorted(get_lst_of_files('./iclapcheeks/watermark/' + reply_message.file.name, []))
        #filename = filename + "/"
