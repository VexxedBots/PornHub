...
async def _(event):
    ...
    packname = f"@iclapcheeks Pack "
    packshortname = f"i_clap_cheeks"  # format: Uni_Borg_userid

    is_a_s = is_it_animated_sticker(reply_message)
    file_ext_ns_ion = "iclapcheeks_Sticker.png"
    file = await borg.download_file(reply_message.media)
    uploaded_sticker = None
    if is_a_s:
        file_ext_ns_ion = "AnimatedSticker.tgs"
        uploaded_sticker = await borg.upload_file(file, file_name=file_ext_ns_ion)
        packname = f"iclapcheeks_AnimatedStickers"
        packshortname = f"iclapcheeks_Animated"  # format: Uni_Borg_userid
    ...
    await event.edit("Stealing in progress.....Please remain calm....")
    ...
    await event.edit(f"Sticker Has Been Stolen xD! Find your loot [here](t.me/addstickers/{packshortname})")
